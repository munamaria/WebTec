...
<body>
  <section class="parent">
    ...
    <form class="form1" name="form_login" action="" onsubmit="return validateLoginForm()" method="post">
      <input class="un " type="text"  id="mail_id" name="mail_id" placeholder="Username" value="<?=$email;?>">
      <input class="pass" type="password"  id="login_password" name="login_password" placeholder="Password" value="<?=$pass;?>">
      <input  class="submit" type="submit"  name="submit" value="Sign in">
      <h4>New here? PLease Sign Up</h4>   
